...
import logoMori from '@/images/logos/mori.webp'
import logoSaic from '@/images/logos/saic.png'
import logoJacobs from '@/images/logos/jacobs.svg'
...
function WrenchScredriverIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md ring-1 shadow-zinc-800/5 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
        <Image src={role.logo} alt="" className={clsx("h-7 w-7", role.logo === logoJacobs && 'bg-white rounded-2xl')} unoptimized />
      </div>
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'Jacobs Technology: NASA',
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/dcrendon-resume-web.pdf" variant="secondary" className="group mt-6 w-full">
        Download Resume
...
function Projects() {
  const projects = [
    {
      ...
      logo: logoNASA,
      tech: 'Python, CKAN, PostgreSQL, Docker, AWS',
    },
    {
      ...
      logo: logoNASA,
      tech: 'Model Viewer, JavaScript, HTML, CSS',
    },
    {
      name: 'Bebo AI',
      description:
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        <WrenchScredriverIcon className="h-6 w-6 flex-none" />
      ...
      <ol className="mt-6 space-y-4">
        {projects.map((project, projectIndex) => (
          <li className="flex gap-4" key={projectIndex}>
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md ring-1 shadow-zinc-800/5 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
              <Image src={project.logo} alt="" className={clsx("h-7 w-7", project.logo === logoJacobs && 'bg-white rounded-2xl')} unoptimized />
            </div>
            <dl className="flex flex-auto flex-wrap gap-x-2">
              <dt className="sr-only">Company</dt>
              <dd className="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/dcrendon"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/dcrendon/"
